...
namespace BigOn.WebUI.AppCode.Extensions
{
    public static partial class Extension
    {
        ...
        {
            byte[] buffer = Encoding.UTF8.GetBytes($"{saltKey}{value}BigOn.WebUI.AppCode");
        ...
        //{
        //    byte[] buffer = Encoding.UTF8.GetBytes($"{saltKey}{value}1BigOn.WebUI.AppCode");
        ...
        //{
        //    byte[] buffer = Encoding.UTF8.GetBytes($"{saltKey}{value}256BigOn.WebUI.AppCode");
